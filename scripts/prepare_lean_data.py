...
def prepare_lean_dataset():
    ...
    dataset = load_dataset(
        "parquet", data_files="/app/qi/backup/data/RPROVER/Lean-workbook-proofs/data/train-00000-of-00001.parquet"
    )["train"]

    # 处理proof提取prompt
    processed_data = {"context_messages": [], "formal_statement": []}
