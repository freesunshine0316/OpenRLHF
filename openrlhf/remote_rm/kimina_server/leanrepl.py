...
path_to_repl = '/home/qi/.elan/bin/lake'
MATHLIB_PATH= '/app/qi/backup/data/RPROVER/OpenRLHF/openrlhf/remote_rm/ds_prover/lean/'
path_to_mathlib = f"{MATHLIB_PATH}/mathlib4"
